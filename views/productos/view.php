    ...
    <div class="producto-body">
        ...
        <div class="especificaciones-grid">
            ...
            <div class="especificacion-card">
                ...
                <div class="especificacion-content">
                    <div class="especificacion-label">Lugar</div>
                    <div class="especificacion-value">
                        <?= $model->lugar ? Html::encode($model->lugar->nombre) : 'No especificado' ?>
                    </div>
                </div>
            </div>
                        ...
                        <li class="factura-item">
                            <div class="factura-info">
                                <div class="factura-codigo">
                                    ...
                                    Factura: <?= Html::encode($item->factura->codigo) ?>
                                </div>
                                <div class="factura-detalles">
                                    <?php if ($item->factura->cliente): ?>
                                        Cliente: <?= Html::encode($item->factura->cliente->nombre) ?> | 
                                    <?php endif; ?>
                                    Fecha: <?= Yii::$app->formatter->asDate($item->factura->fecha) ?> |
                                    ...
                                    <?php if ($precioParalelo && $precioOficial): ?>
                                        ...
                                        <small style="color: #6c757d;">
                                            Bs. <?= number_format($precioUnitarioVes, 2, ',', '.') ?> | 
                                            <strong>$<?= number_format($precioUnitarioUsdOficial, 2) ?></strong> (BCV)
                                        </small>
                                    <?php endif; ?>
                                </div>
                            </div>
