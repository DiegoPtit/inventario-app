...
<div class="proveedores-form">
    <div class="proveedores-form-container">
        ...
        <div class="stepper-container">
            <div class="stepper">
                ...
                <div class="step" data-step="2">
                    ...
                    <div class="step-label">Ubicación y Contacto</div>
                </div>
            </div>
        </div>
        ...
        <div class="step-content active" data-step="1">
            <div class="form-section">
                ...
                <p class="section-description">
                    Comienza ingresando la información básica del proveedor.
                </p>
                
                <div class="info-card">
                    <i class="bi bi-info-circle"></i>
                    <span class="info-card-text">
                        La <strong>razón social</strong> es obligatoria. Este será el identificador principal del proveedor en el sistema.
                    </span>
                </div>
                ...
                <?= $form->field($model, 'documento_identificacion')->textInput([
                    'maxlength' => true,
                    'placeholder' => 'RNC, NIT, RUT, etc.'
        ...
        <div class="step-content" data-step="2">
            <div class="form-section">
                ...
                <p class="section-description">
                    Proporciona la ubicación y datos de contacto del proveedor.
                </p>

                <div class="info-card">
                    <i class="bi bi-info-circle"></i>
                    <span class="info-card-text">
                        Esta información te permitirá comunicarte con el proveedor y conocer su ubicación.
                    </span>
                </div>
        ...
        <div class="step-navigation">
            ...
            <button type="submit" class="btn-step btn-submit-final" id="btn-submit" style="display: none;">
                ...
                <?= $model->isNewRecord ? 'Registrar Proveedor' : 'Actualizar Proveedor' ?>
            </button>
        </div>
...
function updateStep() {
    ...
    document.querySelector('.proveedores-form-container').scrollIntoView({ 
        behavior: 'smooth', 
        block: 'start' 
    });
}
